...
local Utility = {}
local Objects = {}
function Angor:DraggingEnabled(frame, parent)
...
function Angor.CreateLib(kavName, themeList)
    ...
    Angor:DraggingEnabled(MainHeader, Main)
    ...
    function Angor:ChangeColor(prope,color)
